...
<div style="text-align: center; margin-bottom: 32px;">
    ...
    <p style="color: var(--muted);">We've sent a verification code to <strong>{{ session('google_user_data.email') ?? 'your email' }}</strong></p>
</div>

<form class="auth-form" data-auth-form method="POST" action="{{ route('auth.google.verify-otp') }}">
    @csrf
    <div class="field">
